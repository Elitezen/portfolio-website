			...
			<main>
				...
				<section>
					...
					<p>
						...
						From curating <a href="/portfolio">personal projects</a>, to leading the development of a new
						major version of an <a href="/portfolio/open-source">open-sourced library</a>, to managing the <a href="/portfolio/scriptly-studios">database and moderation
				...
				<section>
					...
					<section className="image-and-text">
						<div className="image-and-text-content">
							...
							<p>
								"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus eaque ipsum saepe optio velit reprehenderit reiciendis at ut quas quidem fuga quae aut autem, deleniti consequuntur cum sit nam unde!"
							</p>
						</div>
					</section>
				</section>
