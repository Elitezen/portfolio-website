        ...
        <>
            ...
            <main>
                ...
                <section className="sub-section">
                    ...
                    <p>
                        I designed, developed, and managed a promotional codes
                        system for a collaboration event between{" "}
                        <a href="https://www.roblox.com/games/3214114884/Flag-Wars">
                            Flag Wars
                        </a>{" "}
                        and <a href="https://freshcut.gg/home">Fresh Cut</a>.
                        The system involved the game's client communicating with
                        my API, which performed read/write operations on a
                        MongoDB database I managed. The system was a success,
                        having 0 errors in production and maintaining an
                    </p>
                    ...
                    <div className="image-row">
                        <figure>
                            <img
                                src={CodesAPICode}
                                alt="Screen shot of a sample of code"
                            />
                        ...
                        <figure>
                            <img
                                src={CodesAPIFlowChart}
                                alt="Flowchart of the codes API process"
                            />
